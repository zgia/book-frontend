export default {
  ...
  chapter: {
    ...
    confirm_download_chapter: '確認下載圖書 《{title}》 嗎？下載儲存為壓縮的文字檔案。 ',
  ...
  common: {
    ...
    resp_nodata: '沒有取得到數據，可能介面沒有回應＜{code}＞: {text}。 Error: {err}',
    unknown_error: '未知錯誤',
