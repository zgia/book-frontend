export default {
  ...
  book: {
    ...
    books_downloaded_ok: '已经下载，文件名是：{title}',
    books_downloaded_error: '下载失败：{err}',
  ...
  chapter: {
    ...
    confirm_download_chapter: '确认下载图书 《{title}》 吗？下载保存为压缩的文本文件。',
  ...
  config: {
    ...
    category_edition_click_to_edit: '点击分类名称来编辑',
  ...
  common: {
    ...
    resp_nodata: '没有获取到数据，可能接口没有响应({code}): {text}。Error: {err}',
    unknown_error: '未知错误',
  },
}
