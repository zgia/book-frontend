    ...
    <el-container direction="vertical">
      ...
      <el-footer>
        <el-divider border-style="dashed">
          <span>{{ VITE_COPYRIGHT }}</span> @ <span class="copy-year">{{ (new Date()).getFullYear() }} </span>
        </el-divider>
      </el-footer>
    </el-container>
  </el-config-provider>
...
const locale = computed(() => (lostore.locale === 'zhCN' ? zhCN : (lostore.locale === 'zhTW' ? zhTW : en)))
watch(() => lostore.locale, () => {
  setWebTitle()
})
