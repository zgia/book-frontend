<template>
  <el-dialog :model-value="true" top="8vh" close-icon="IconoirXmarkCircle" :close-on-press-escape="false" :before-close="handleClose" @opened="closeLoading" :title="$t('user.pagetitle_edit_pwd')"
    :width="props.dgwidth">
    <el-form :model="pwdForm" ref="ruleFormRef" label-position="top" label-width="auto" :rules="rules" size="large" class="edit-doctor">
      <el-form-item :label="$t('user.edit_pwd_old_pwd')" label-width="140px" prop="password">
        <el-input v-model="pwdForm.password" type="password" clearable show-password autocomplete="off" :placeholder="$t('user.edit_pwd_old_pwd_placeholder')" />
      </el-form-item>
      <el-form-item :label="$t('user.edit_pwd_new_pwd')" label-width="140px" prop="password1">
        <el-input v-model="pwdForm.password1" type="password" clearable show-password minlength="6" autocomplete="off" :placeholder="pwd1ph" />
      </el-form-item>
      <el-form-item :label="$t('user.edit_pwd_confirm_pwd')" label-width="140px" prop="password2">
        <el-input v-model="pwdForm.password2" type="password" clearable show-password minlength="6" autocomplete="off" :placeholder="pwd2ph" />
      </el-form-item>
    </el-form>
    <template #footer>
      <el-divider />
