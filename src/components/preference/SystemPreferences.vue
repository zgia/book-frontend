<template>
  <el-dialog :model-value="true" top="8vh" close-icon="IconoirXmarkCircle" :close-on-press-escape="false" :before-close="handleClose" @opened="closeLoading" :title="$t('config.system_preferences')"
    :width="props.dgwidth">
    ...
    <template #footer>
      ...
      <span class="dialog-footer">
        ...
        <el-button size="small" icon="IconoirCheck" type="primary" @click="hideme()">{{ $t('common.btn_save') }}</el-button>
      </span>
    </template>
  </el-dialog>
</template>
