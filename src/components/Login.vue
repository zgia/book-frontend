<template>
  <el-row>
    <el-col :span="colSpan" :offset="colOffset">
      ...
      <el-form hide-required-asterisk :model="loginForm" @keyup.enter="submitForm(ruleFormRef)" ref="ruleFormRef" :rules="rules" label-width="120px"
...
const colSpan = ref(8)
const colOffset = ref(8)
watch(screenWidth, (sw) => {
  colSpan.value = sw < 640 ? 20 : 8
  colOffset.value = sw < 640 ? 2 : 8
